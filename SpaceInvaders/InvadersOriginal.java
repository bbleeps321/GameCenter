...
public class InvadersOriginal extends java.awt.Canvas implements Stage, KeyListener
{
    //constants
    ...
    public void initWorld()
    {
        ...
        backgroundTile = spriteCache.getSprite(DIRECTORY + "oceano.gif");
        background = spriteCache.createCompatible(Stage.WIDTH,  
    ...
    public void paintAmmo(Graphics2D g)
    {
        ...
        {
            BufferedImage bomb = spriteCache.getSprite(DIRECTORY + "bombUL.gif");
    ...
    {
        InvadersOriginal inv = new InvadersOriginal();
        inv.game();
    }
}